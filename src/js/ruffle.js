(() => {
  ...
  var e,
    ...
    t = {
      ...
      124: (e, n, t) => {
        e.exports = t.p + "2edfd2e061ed6fe8f5d2.wasm";
      },
      125: (e, n) => {
        Object.defineProperty(n, "__esModule", { value: !0 });
      },
      ...
      797: (e, n, t) => {
        e.exports = t.p + "66141106596345b8457d.wasm";
      },
      836: (e, n) => {
        Object.defineProperty(n, "__esModule", { value: !0 });
      },
  ...
  (r.m = t),
    ...
    (r.u = (e) => "core.ruffle." + { 482: "7020c4cdffbc0d672689", 655: "d8020f36e5918e887c19" }[e] + ".js"),
    (r.g = (function () {
  ...
  const l = {
    versionNumber: "0.1.0",
    versionName: "0.1.0 nightly 2025-05-21",
    versionChannel: "nightly",
    buildDate: "2025-05-21T00:06:58.919Z",
    commitHash: "cdbb93377b08fb1f4fa007ce2a080596003d565b",
  };
  var u;
  !(function (e) {
  ...
  class S extends x {
    static supportsValue(e) {
      ...
      if (e instanceof x) return S.supportsValue(e.valueOf());
    ...
    constructor(e, n = {}) {
      e instanceof S ? ((n = { ...e.opts, ...n }), (e = e.value)) : e instanceof x && (e = e.valueOf()),
  ...
  function C(e, n, t) {
    ...
    if (n instanceof j && "string" == typeof t) {
      if (t === e.memoizeIntlObject(Intl.PluralRules, n.opts).select(n.value)) return !0;
    }
    return !1;
  }
  function E(e, n, t) {
    return n[t] ? P(e, n[t].value) : (e.reportError(new RangeError("No default")), new z());
  }
  function A(e, n) {
    const t = [],
      a = Object.create(null);
    for (const r of n) "narg" === r.type ? (a[r.name] = q(e, r.value)) : t.push(q(e, r));
  ...
  function q(e, n) {
    switch (n.type) {
      case "str":
        return n.value;
      case "num":
        return new j(n.value, { minimumFractionDigits: n.precision });
      case "var":
        return (function (e, { name: n }) {
          let t;
          if (e.params) {
            if (!Object.prototype.hasOwnProperty.call(e.params, n)) return new z(`$${n}`);
            t = e.params[n];
          } else {
            if (!e.args || !Object.prototype.hasOwnProperty.call(e.args, n))
              return e.reportError(new ReferenceError(`Unknown variable: $${n}`)), new z(`$${n}`);
            t = e.args[n];
          }
          ...
          switch (typeof t) {
            ...
            case "number":
              return new j(t);
            case "object":
              if (S.supportsValue(t)) return new S(t);
            default:
              return e.reportError(new TypeError(`Variable type not supported: $${n}, ${typeof t}`)), new z(`$${n}`);
          }
        })(e, n);
      case "mesg":
        return (function (e, { name: n, attr: t }) {
          const a = e.bundle._messages.get(n);
          if (!a) return e.reportError(new ReferenceError(`Unknown message: ${n}`)), new z(n);
          if (t) {
            const r = a.attributes[t];
            return r ? P(e, r) : (e.reportError(new ReferenceError(`Unknown attribute: ${t}`)), new z(`${n}.${t}`));
          }
          if (a.value) return P(e, a.value);
          return e.reportError(new ReferenceError(`No value: ${n}`)), new z(n);
        })(e, n);
      case "term":
        return (function (e, { name: n, attr: t, args: a }) {
          const r = `-${n}`,
            o = e.bundle._terms.get(r);
          if (!o) return e.reportError(new ReferenceError(`Unknown term: ${r}`)), new z(r);
          if (t) {
            const n = o.attributes[t];
            if (n) {
              e.params = A(e, a).named;
              const t = P(e, n);
              return (e.params = null), t;
            }
            return e.reportError(new ReferenceError(`Unknown attribute: ${t}`)), new z(`${r}.${t}`);
          }
          e.params = A(e, a).named;
          const i = P(e, o.value);
      ...
      case "func":
        return (function (e, { name: n, args: t }) {
          ...
          if (!a) return e.reportError(new ReferenceError(`Unknown function: ${n}()`)), new z(`${n}()`);
          if ("function" != typeof a)
            return e.reportError(new TypeError(`Function ${n}() is not callable`)), new z(`${n}()`);
          try {
            let n = A(e, t);
      ...
      case "select":
        return (function (e, { selector: n, variants: t, star: a }) {
          let r = q(e, n);
          if (r instanceof z) return E(e, t, a);
          for (const n of t) {
            if (C(e, r, q(e, n.key))) return P(e, n.value);
          }
          return E(e, t, a);
        })(e, n);
      default:
  ...
  function F(e, n) {
    if (e.dirty.has(n)) return e.reportError(new RangeError("Cyclic reference")), new z();
    e.dirty.add(n);
    const t = [],
    ...
    for (const r of n)
      if ("string" != typeof r) {
        if ((e.placeables++, e.placeables > 100))
          throw (
            (e.dirty.delete(n), new RangeError(`Too many placeables expanded: ${e.placeables}, max allowed is 100`))
          );
        a && t.push("\u2068"), t.push(q(e, r).toString(e)), a && t.push("\u2069");
      } else t.push(e.bundle._transform(r));
    return e.dirty.delete(n), t.join("");
  }
  function P(e, n) {
    return "string" == typeof n ? e.bundle._transform(n) : F(e, n);
  }
  class D {
    constructor(e, n, t) {
  ...
  function O(e, n) {
    ...
    if (t instanceof j) return new j(t.valueOf(), { ...t.opts, ...M(n, $) });
    if (t instanceof S) return new j(t.toNumber(), { ...M(n, $) });
  ...
  function T(e, n) {
    ...
    if (t instanceof S || t instanceof j) return new S(t, M(n, I));
  ...
  class L {
    constructor(e, { functions: n, useIsolating: t = !0, transform: a = (e) => e } = {}) {
      (this._terms = new Map()),
        ...
        (this._functions = { NUMBER: O, DATETIME: T, ...n }),
    ...
    formatPattern(e, n = null, t = null) {
      ...
      try {
        return F(a, e).toString(a);
      } catch (e) {
        if (a.errors && e instanceof Error) return a.errors.push(e), new z().toString(a);
        throw e;
      }
    }
  }
  const N = /^(-?[a-zA-Z][\w-]*) *= */gm,
    ...
    B = /(-?[0-9]+(?:\.([0-9]+))?)/y,
    V = /([a-zA-Z][\w-]*)/y,
    H = /([$-])?([a-zA-Z][\w-]*)(?:\.([a-zA-Z][\w-]*))?/y,
    J = /^[A-Z][A-Z0-9_-]*$/,
    Z = /([^{}\n\r]+)/y,
    K = /([^\\"\n\r]*)/y,
    Q = /\\([\\"])/y,
    G = /\\u([a-fA-F0-9]{4})|\\U([a-fA-F0-9]{6})/y,
    Y = /^\n+/,
    X = / +$/,
    ee = / *\r?\n/g,
    ne = /( *)$/,
  ...
  class de {
    constructor(e) {
      ...
      function l() {
        let a;
        if ((t(Z) && (a = i(Z)), "{" === e[n] || "}" === e[n])) return u(a ? [a] : [], 1 / 0);
        let r = g();
        return r ? (a ? u([a, r], r.length) : ((r.value = b(r.value, Y)), u([r], r.length))) : a ? b(a, X) : null;
      }
      function u(a = [], r) {
        for (;;) {
          if (t(Z)) {
        ...
        let o = a.length - 1,
          s = a[o];
        "string" == typeof s && (a[o] = b(s, X));
        let l = [];
        for (let e of a) e instanceof fe && (e = e.value.slice(0, e.value.length - r)), e && l.push(e);
        return l;
      }
      function c() {
        r(te, SyntaxError);
        ...
        if (r(se)) {
          ...
          return r(ae, SyntaxError), { type: "select", selector: e, ...n };
        }
      ...
      function d() {
        ...
        if (t(H)) {
          ...
          if (r(ie)) {
            ...
            if (J.test(a)) return { type: "func", name: a, args: o };
      ...
      function f() {
        let e = d();
        return "mesg" !== e.type ? e : r(le) ? { type: "narg", name: e.name, value: p() } : e;
      }
      function m() {
        let e;
        return r(re, SyntaxError), (e = t(B) ? h() : { type: "str", value: i(V) }), r(oe, SyntaxError), e;
      }
      function p() {
        if (t(B)) return h();
        if ('"' === e[n])
  ...
  class pe {
    ...
    addLikelySubtags() {
      const e = (function (e) {
        if (Object.prototype.hasOwnProperty.call(he, e)) return new pe(he[e]);
        const n = new pe(e);
        if (n.language && ve.includes(n.language)) return (n.region = n.language.toUpperCase()), n;
        return null;
  ...
  const he = {
    ...
    ve = ["az", "bg", "cs", "de", "es", "fi", "fr", "hu", "it", "lt", "lv", "nl", "pl", "ro", "ru"];
  function ge(e, n, { strategy: t = "filtering", defaultLocale: a } = {}) {
    const r = (function (e, n, t) {
      const a = new Set(),
        r = new Map();
      for (let e of n) new pe(e).isWellFormed && r.set(e, new pe(e));
      e: for (const n of e) {
  ...
  function be() {
    if ("function" != typeof Map.prototype.set) {
      ...
      return (n.style.display = "none"), document.documentElement.append(n), (Map = n.contentWindow.Map), n.remove(), e;
    }
  }
  function we(e) {
    e && (Map = e);
  ...
  function ye() {
    ("function" == typeof Array.prototype.reduce && ke(Array.prototype.reduce)) ||
      ...
      ("function" == typeof Window && ke(Window)) ||
        ("function" == typeof window.constructor && ke(window.constructor) && (window.Window = window.constructor)),
  ...
  const Re = {
      ...
      "fi-FI": { "context_menu.ftl": "", "messages.ftl": "", "save-manager.ftl": "", "volume-controls.ftl": "" },
      "fr-FR": {
        "context_menu.ftl":
  ...
  for (const [e, n] of Object.entries(Re)) {
    ...
    if (n) {
      ...
      for (const [r, o] of Object.entries(n))
        if (o) {
          a ??= be();
          for (const n of t.addResource(new de(o))) console.error(`Error in text for ${e} ${r}: ${n}`);
        }
      we(a);
    }
    xe[e] = t;
  ...
  function je(e, n) {
    const t = be(),
      a = ge(navigator.languages, Object.keys(xe), { defaultLocale: "en-US" });
    for (const t in a) {
      const r = ze(a[t], e, n);
      if (r) return r;
    }
    return console.error(`Unknown text key '${e}'`), we(t), e;
  }
  function Se(e, n) {
  ...
  try {
    if (document.currentScript instanceof HTMLScriptElement && "" !== document.currentScript.src) {
      ...
      e.endsWith(".js") || e.endsWith("/") || (e += "/"),
        (Me = new URL(".", e)),
        ($e = Me.protocol.includes("extension"));
    }
  } catch (e) {
    console.warn("Unable to get currentScript URL", e);
  }
  const Oe = "https://ruffle.rs";
  ...
  const Ue = {
    OpenDemo: { type: "open_link", url: Oe + "/demo", label: je("ruffle-demo") },
    DownloadDesktop: { type: "open_link", url: Oe + "/downloads#desktop-app", label: je("ruffle-desktop") },
    UpdateRuffle: { type: "open_link", url: Oe + "/downloads", label: je("update-ruffle") },
    CreateReport: { type: "create_report" },
    ShowDetails: { type: "show_details" },
    createReportOrUpdate() {
      return _e() ? this.UpdateRuffle : this.CreateReport;
    },
    openWiki: (e, n) => ({
      type: "open_link",
      url: `https://github.com/ruffle-rs/ruffle/wiki/${e}`,
      label: n ?? je("ruffle-wiki"),
    }),
  };
  function Be(e, n, t, a) {
    const r = t.join(""),
      { body: o, actions: i } = (function (e) {
        if (e instanceof Ie)
          return e.swfUrl && !e.swfUrl.protocol.includes("http")
            ? { body: Se("error-file-protocol"), actions: [Ue.OpenDemo, Ue.DownloadDesktop] }
            : window.location.origin === e.swfUrl?.origin || window.location.protocol.includes("extension")
            ? { body: Se("error-swf-fetch"), actions: [Ue.ShowDetails] }
            : {
                body: Se("error-swf-cors"),
                actions: [Ue.openWiki("Using-Ruffle#configure-cors-header"), Ue.ShowDetails],
              };
        if (e instanceof Te) return { body: Se("error-invalid-swf"), actions: [Ue.ShowDetails] };
        if (e instanceof We) {
          if ("file:" === window.location.protocol)
            return { body: Se("error-file-protocol"), actions: [Ue.OpenDemo, Ue.DownloadDesktop] };
          const n = String(e.cause.message).toLowerCase();
          if (n.includes("mime"))
            return {
              body: Se("error-wasm-mime-type"),
              actions: [Ue.openWiki("Using-Ruffle#configure-webassembly-mime-type"), Ue.ShowDetails],
            };
          if (n.includes("networkerror") || n.includes("failed to fetch") || n.includes("load failed"))
            return {
              body: Se("error-wasm-cors"),
              actions: [Ue.openWiki("Using-Ruffle#configure-cors-header"), Ue.ShowDetails],
            };
          if (n.includes("disallowed by embedder"))
            return {
              body: Se("error-csp-conflict"),
              actions: [Ue.openWiki("Using-Ruffle#configure-wasm-csp"), Ue.ShowDetails],
            };
          if ("CompileError" === e.cause.name && n.includes("bad type"))
            return { body: Se("error-wasm-unsupported-browser"), actions: [Ue.openWiki("#web"), Ue.ShowDetails] };
          if ("CompileError" === e.cause.name)
            return {
              body: Se("error-wasm-invalid"),
              actions: [Ue.openWiki("Using-Ruffle#addressing-a-compileerror"), Ue.ShowDetails],
            };
          if (
            (n.includes("could not download wasm module") || n.includes("webassembly compilation aborted")) &&
            "TypeError" === e.cause.name
          )
            return { body: Se("error-wasm-download"), actions: [Ue.ShowDetails] };
          if ("TypeError" === e.cause.name) {
            const e = Se("error-javascript-conflict");
            return (
              _e() && e.appendChild(Se("error-javascript-conflict-outdated", { buildDate: l.buildDate })),
              { body: e, actions: [Ue.createReportOrUpdate(), Ue.ShowDetails] }
            );
          }
          return navigator.userAgent.includes("Edg") && n.includes("webassembly is not defined")
            ? {
                body: Se("error-wasm-disabled-on-edge"),
                actions: [
                  Ue.openWiki("Frequently-Asked-Questions-For-Users#edge-webassembly-error", je("more-info")),
                  Ue.ShowDetails,
                ],
              }
            : {
                body: Se("error-wasm-not-found"),
                actions: [Ue.openWiki("Using-Ruffle#configuration-options"), Ue.ShowDetails],
              };
        }
        return e instanceof Le
          ? {
              body: Se("error-javascript-config"),
              actions: [Ue.openWiki("Using-Ruffle#javascript-api"), Ue.ShowDetails],
            }
          : {
              body: Se("error-unknown", { buildDate: l.buildDate, outdated: String(_e) }),
              actions: [Ue.createReportOrUpdate(), Ue.ShowDetails],
            };
      })(n),
      s = (0, Ne.createRef)(),
      u = () => {
        s.current.classList.add("details"),
          s.current.replaceChildren((0, y.jsx)("textarea", { readOnly: !0, children: r }));
      };
    (e.textContent = ""),
      e.appendChild(
        (0, y.jsxs)("div", {
          id: "panic",
          children: [
            (0, y.jsx)("div", { id: "panic-title", children: je("panic-title") }),
            (0, y.jsx)("div", { id: "panic-body", ref: s, children: o }),
            (0, y.jsx)("div", {
              id: "panic-footer",
              children: (0, y.jsx)("ul", {
                children: i.map((e) =>
                    ...
                    if ("show_details" === e.type) {
                      ...
                      return (0, y.jsx)("li", {
                        children: (0, y.jsx)("a", {
                          ...
                          onClick: e,
                          children: je("view-error-details"),
                        }),
                      });
                    }
                    if ("open_link" === e.type)
                      return (0, y.jsx)("li", {
                        children: (0, y.jsx)("a", { href: e.url, target: "_top", children: e.label }),
                      });
                    {
                      let e;
                      ...
                      return (
                        ...
                        (n += o),
                        (0, y.jsx)("li", {
                          children: (0, y.jsx)("a", { href: n, target: "_top", children: je("report-bug") }),
                        })
                      );
                    }
    ...
    if (void 0 !== window.customElements)
      for (; a < 999; ) {
        ...
        if ((a > 0 && (t = t + "-" + a), void 0 === window.customElements.get(t)))
          return window.customElements.define(t, n), (Ye[e] = { class: n, name: t, internalName: e }), t;
        a += 1;
      }
  ...
  function nn(e, n) {
    if (
      (en(n.allowScriptAccess) && e.setAllowScriptAccess(n.allowScriptAccess),
      en(n.backgroundColor) &&
      ...
      en(n.upgradeToHttps) && e.setUpgradeToHttps(n.upgradeToHttps),
      en(n.compatibilityRules) && e.setCompatibilityRules(n.compatibilityRules),
      en(n.letterbox) && e.setLetterbox(n.letterbox.toLowerCase()),
      en(n.base) && e.setBaseUrl(n.base),
      en(n.menu) && e.setShowMenu(n.menu),
      en(n.allowFullscreen) && e.setAllowFullscreen(n.allowFullscreen),
      en(n.salign) && e.setStageAlign(n.salign.toLowerCase()),
      en(n.forceAlign) && e.setForceAlign(n.forceAlign),
      en(n.quality)
      ...
      en(n.scale) && e.setScale(n.scale.toLowerCase()),
      en(n.forceScale) && e.setForceScale(n.forceScale),
      en(n.frameRate) && e.setFrameRate(n.frameRate),
      en(n.wmode) && e.setWmode(n.wmode),
      en(n.logLevel) && e.setLogLevel(n.logLevel),
      en(n.maxExecutionDuration) &&
      ...
      en(n.playerVersion) && e.setPlayerVersion(n.playerVersion),
      en(n.preferredRenderer) && e.setPreferredRenderer(n.preferredRenderer),
      en(n.openUrlMode) && e.setOpenUrlMode(n.openUrlMode.toLowerCase()),
      en(n.allowNetworking) && e.setAllowNetworking(n.allowNetworking.toLowerCase()),
      en(n.credentialAllowList) && e.setCredentialAllowList(n.credentialAllowList),
      en(n.playerRuntime) && e.setPlayerRuntime(n.playerRuntime),
      en(n.socketProxy))
    )
      for (const t of n.socketProxy) e.addSocketProxy(t.host, t.port, t.proxyUrl);
    if (en(n.gamepadButtonMapping))
      for (const [t, a] of Object.entries(n.gamepadButtonMapping)) e.addGamepadButtonMapping(t, a);
    if (en(n.urlRewriteRules))
  ...
  class sn {
    constructor(e, n, t) {
      (this.contextMenuForceDisabled = !1),
        ...
        (this.SaveRow = ({ rowKey: e, solName: n, solData: t }) =>
          (0, y.jsxs)("tr", {
            children: [
              (0, y.jsx)("td", { title: e, children: n }),
              (0, y.jsx)("td", {
                children: (0, y.jsx)("span", {
                  class: "save-option",
                  id: "download-save",
                  title: je("save-download"),
                  onClick: () =>
                    mn(
                      (function (e, n) {
                        const t = pn(e);
        ...
        this.shadow.appendChild(Ee.content.cloneNode(!0)),
      ...
      a && (a.addEventListener("click", this.backupSaves.bind(this)), (a.innerText = je("save-backup-all")));
      const r = this.unmuteOverlay.querySelector("#unmute-overlay-svg");
      if (r) {
        r.querySelector("#unmute-text").textContent = je("click-to-unmute");
      }
    ...
    async ensureFreshInstance() {
      ...
      const [e, n] = await Ge(this.onRuffleDownloadProgress.bind(this)).catch((e) => {
    ...
    async reloadWithCanvasRenderer() {
      if (this.loadedConfig && this.loadedConfig.preferredRenderer !== h.Canvas) {
        ...
        if (!this.loadedConfig) throw new Error("Cannot reload if load wasn't first called");
        this.panic(new Error(je("error-canvas-reload")));
      }
    }
    async load(e, n = !1) {
      if (((e = this.checkOptions(e)), this.element.isConnected && !this.isUnusedFallbackObject())) {
        if (!fn(this.element))
          try {
            (this.loadedConfig = {
              ...R,
              ...(n && "url" in e ? { allowScriptAccess: gn("samedomain", e.url) } : {}),
              ...
              "url" in e
                ? (console.log(`Loading SWF file ${e.url}`),
                  ...
                  this.instance.stream_from(this.swfUrl.href, rn(e.parameters)))
                : "data" in e &&
                  (console.log("Loading SWF data"),
                  delete this.swfUrl,
                  this.instance.load_data(new Uint8Array(e.data), rn(e.parameters), e.swfFileName || "movie.swf"));
          } catch (e) {
    ...
    confirmReloadSave(e, n, t) {
      if (hn(n) && localStorage[e]) {
        if (!t) {
          if (!confirm(je("save-delete-prompt"))) return;
        }
        ...
        if (a.includes(o) && e.startsWith(r)) {
          return void (
            confirm(je("save-reload-prompt", { action: t ? "replace" : "delete" })) &&
            this.loadedConfig &&
            (this.destroy(),
    ...
    populateSaves() {
      ...
      (e.textContent = ""),
        Object.keys(localStorage).forEach((n) => {
          ...
          t && a && hn(a) && e.appendChild((0, y.jsx)(this.SaveRow, { rowKey: n, solName: t, solData: a }));
        });
    }
    async backupSaves() {
      ...
      mn(new Blob([e.save()], { type: "application/zip" }), "saves.zip");
    }
    ...
    contextMenuItems() {
      ...
      return (
        this.fullscreenEnabled &&
          (this.isFullscreen
            ? n.push({ text: je("context-menu-exit-fullscreen"), onClick: async () => this.setFullscreen(!1) })
            : n.push({ text: je("context-menu-enter-fullscreen"), onClick: async () => this.setFullscreen(!0) })),
        n.push({
          text: je("context-menu-volume-controls"),
          onClick: async () => {
        ...
        this.instance &&
          ...
          (t(), n.push({ text: je("context-menu-download-swf"), onClick: this.downloadSwf.bind(this) })),
        navigator.clipboard &&
          window.isSecureContext &&
          n.push({
            text: je("context-menu-copy-debug-info"),
            onClick: () => navigator.clipboard.writeText(this.getPanicData()),
          }),
        this.checkSaves() &&
          n.push({ text: je("context-menu-open-save-manager"), onClick: this.openSaveManager.bind(this) }),
        t(),
        n.push({
          text: je("context-menu-about-ruffle", { flavor: $e ? "extension" : "", version: l.versionName }),
          async onClick() {
    ...
    pointerDown(e) {
      (this.pointerDownPosition = new on(e.pageX, e.pageY)),
        (this.pointerMoveMaxDistance = 0),
    ...
    checkLongPressMovement(e) {
      if (null !== this.pointerDownPosition) {
        const n = new on(e.pageX, e.pageY),
      ...
      for (const e of this.contextMenuItems())
        if (null === e)
          this.contextMenuElement.appendChild(
            (0, y.jsx)("li", { class: "menu-separator", children: (0, y.jsx)("hr", {}) })
          );
        else {
          const { text: n, onClick: t, enabled: a } = e,
            r = (0, y.jsx)("li", { class: { "menu-item": !0, disabled: !1 === a }, "data-text": n, children: n });
              ...
              () => {
                ...
                (n.src = (() => {
                  ...
                  return `data:audio/wav;base64,UklGRisAAABXQVZFZm10IBAAAAABAAEA${window
                    .btoa(String.fromCharCode(...new Uint8Array(n)))
    ...
    panic(e) {
      ...
      t.push(this.getPanicData()), Be(this.container, n, t, this.swfUrl), this.destroy();
    }
    addOpenInNewTabMessage(e, n) {
      const t = new URL(n);
      if (this.loadedConfig?.parameters) {
        const e = rn(this.loadedConfig?.parameters);
      ...
      (r.className = "message"), r.appendChild(Se("message-cant-embed"));
      const o = document.createElement("div"),
        i = document.createElement("a");
      (i.innerText = je("open-in-new-tab")),
        (i.onclick = () => e(t)),
        o.appendChild(i),
        r.appendChild(o),
        a.appendChild(r),
    ...
    displayRootMovieDownloadFailedMessage(e) {
      ...
      if (n && this.swfUrl && window.location.origin !== this.swfUrl.origin)
        ...
        const n = e ? new Te(this.swfUrl) : new Ie(this.swfUrl);
        this.panic(n);
      }
    }
    displayMessage(e) {
    ...
    displayClipboardModal(e) {
      ...
      n &&
        ((n.textContent = je("clipboard-message-description", { variant: e ? "access-denied" : "unsupported" })),
    ...
    setMetadata(e) {
      (this.metadata = e),
        ...
        this.hideSplashScreen(),
        this.element.dispatchEvent(new CustomEvent(sn.LOADED_METADATA)),
        this.element.dispatchEvent(new CustomEvent(sn.LOADED_DATA));
    }
  }
  (sn.LOADED_METADATA = "loadedmetadata"), (sn.LOADED_DATA = "loadeddata");
  class ln {
    constructor(e, n) {
  ...
  function un(e, n) {
    ...
    const r = gn(n("allowScriptAccess"), e);
  ...
  class yn {
    constructor(e) {
      bn.set(this, void 0), wn(this, bn, e, "f");
    }
    addFSCommandHandler(e) {
      kn(this, bn, "f").addFSCommandHandler(e);
    }
    get readyState() {
      return kn(this, bn, "f")._readyState;
    }
    get metadata() {
      return kn(this, bn, "f").metadata;
    }
    get loadedConfig() {
      return kn(this, bn, "f").loadedConfig ?? null;
    }
    async reload() {
      await kn(this, bn, "f").reload();
    }
    async load(e, n = !1) {
      await kn(this, bn, "f").load(e, n);
    }
    resume() {
      kn(this, bn, "f").play();
    }
    get isPlaying() {
      return kn(this, bn, "f").isPlaying;
    }
    get volume() {
      return kn(this, bn, "f").volume;
    }
    set volume(e) {
      kn(this, bn, "f").volume = e;
    }
    get fullscreenEnabled() {
      return kn(this, bn, "f").fullscreenEnabled;
    }
    get isFullscreen() {
      return kn(this, bn, "f").isFullscreen;
    }
    setFullscreen(e) {
      kn(this, bn, "f").setFullscreen(e);
    }
    requestFullscreen() {
      kn(this, bn, "f").enterFullscreen();
    }
    exitFullscreen() {
      kn(this, bn, "f").exitFullscreen();
    }
    async downloadSwf() {
      await kn(this, bn, "f").downloadSwf();
    }
    displayMessage(e) {
      kn(this, bn, "f").displayMessage(e);
    }
    suspend() {
      kn(this, bn, "f").pause();
    }
    ...
    set traceObserver(e) {
      kn(this, bn, "f").traceObserver = e;
    }
    get config() {
      return kn(this, bn, "f").config;
    }
    set config(e) {
      kn(this, bn, "f").config = e;
    }
    callExternalInterface(e, ...n) {
      return kn(this, bn, "f").callExternalInterface(e, n);
    }
  }
  bn = new WeakMap();
  var Rn,
  ...
  class Sn extends HTMLElement {
    ...
    get readyState() {
      return zn(this, Rn, "f")._readyState;
    }
    get metadata() {
      return zn(this, Rn, "f").metadata;
    }
    constructor() {
      super(),
        Rn.set(this, void 0),
            ...
            (e) => {
              try {
                Object.defineProperty(this, e, {
                  value: (...n) => zn(this, Rn, "f").callExternalInterface(e, n),
                  configurable: !0,
                });
              } catch (n) {
        ...
        zn(this, Rn, "f").addFSCommandHandler((e, n) => {
          zn(this, xn, "f")?.call(this, e, n);
        });
    }
    ruffle(e) {
      if (1 === (e ?? 1)) return new yn(zn(this, Rn, "f"));
      throw new Error(`Version ${e} not supported.`);
    }
    get loadedConfig() {
      return zn(this, Rn, "f").loadedConfig ?? null;
    }
    connectedCallback() {
      zn(this, Rn, "f").updateStyles();
    }
    static get observedAttributes() {
      return ["width", "height", "align"];
    }
    attributeChangedCallback(e, n, t) {
      Sn.observedAttributes.includes(e) && zn(this, Rn, "f").updateStyles();
    }
    disconnectedCallback() {
      zn(this, Rn, "f").destroy();
    }
    async reload() {
      await zn(this, Rn, "f").reload();
    }
    async load(e, n = !1) {
      await zn(this, Rn, "f").load(e, n);
    }
    play() {
      zn(this, Rn, "f").play();
    }
    get isPlaying() {
      return zn(this, Rn, "f").isPlaying;
    }
    get volume() {
      return zn(this, Rn, "f").volume;
    }
    set volume(e) {
      zn(this, Rn, "f").volume = e;
    }
    get fullscreenEnabled() {
      return zn(this, Rn, "f").fullscreenEnabled;
    }
    get isFullscreen() {
      return zn(this, Rn, "f").isFullscreen;
    }
    setFullscreen(e) {
      zn(this, Rn, "f").setFullscreen(e);
    }
    enterFullscreen() {
      zn(this, Rn, "f").enterFullscreen();
    }
    exitFullscreen() {
      zn(this, Rn, "f").exitFullscreen();
    }
    async downloadSwf() {
      await zn(this, Rn, "f").downloadSwf();
    }
    pause() {
      zn(this, Rn, "f").pause();
    }
    set traceObserver(e) {
      zn(this, Rn, "f").traceObserver = e;
    }
    debugPlayerInfo() {
      return "";
    }
    PercentLoaded() {
      return zn(this, Rn, "f")._readyState === u.Loaded ? 100 : 0;
    }
    get config() {
      return zn(this, Rn, "f").config;
    }
    set config(e) {
      zn(this, Rn, "f").config = e;
    }
    displayMessage(e) {
      zn(this, Rn, "f").displayMessage(e);
    }
  }
  function Cn(e, n) {
    if (e) {
  ...
  class En extends Sn {
    ...
    static get observedAttributes() {
      return [...Sn.observedAttributes, "src"];
    }
    attributeChangedCallback(e, n, t) {
    ...
    static isInterdictable(e) {
      ...
      return !!n && !fn(e) && (cn(n) ? (dn(e, "src"), !1) : De(n, t));
    }
    static fromNativeEmbedElement(e) {
      const n = Xe("ruffle-embed", En),
  ...
  class qn extends Sn {
    ...
    connectedCallback() {
      super.connectedCallback(), (this.params = An(this));
      let e = null;
      if (
    ...
    static isInterdictable(e) {
      ...
      return o === "clsid:D27CDB6E-AE6D-11cf-96B8-444553540000".toLowerCase()
        ? !Array.from(e.getElementsByTagName("object")).some(qn.isInterdictable) &&
            !Array.from(e.getElementsByTagName("embed")).some(En.isInterdictable)
        : !o && De(r, t);
    }
    static fromNativeObjectElement(e) {
      const n = Xe("ruffle-object", qn),
        t = document.createElement(n);
      for (const n of Array.from(e.getElementsByTagName("embed"))) En.isInterdictable(n) && n.remove();
      for (const n of Array.from(e.getElementsByTagName("object"))) qn.isInterdictable(n) && n.remove();
      return Cn(e, t), t;
    }
    get height() {
      return this.getAttribute("height") || "";
  ...
  class Nn {
    constructor(e) {
      if ((Fn.set(this, void 0), Pn.set(this, void 0), Wn(this, Fn, [], "f"), Wn(this, Pn, {}, "f"), e))
        for (let n = 0; n < e.length; n++) this.install(e[n]);
    }
    install(e) {
      const n = new _n(e),
        t = Ln(this, Fn, "f").length;
      Ln(this, Fn, "f").push(n),
        (Ln(this, Pn, "f")[e.type] = n),
        Object.defineProperty(this, n.type, { configurable: !0, enumerable: !1, value: n }),
        (this[t] = n);
    }
    item(e) {
      return Ln(this, Fn, "f")[e >>> 0];
    }
    namedItem(e) {
      return Ln(this, Pn, "f")[e];
    }
    get length() {
      return Ln(this, Fn, "f").length;
    }
    [((Fn = new WeakMap()), (Pn = new WeakMap()), Symbol.iterator)]() {
      return Ln(this, Fn, "f")[Symbol.iterator]();
    }
  ...
  class _n {
    constructor(e) {
      Dn.set(this, void 0), Wn(this, Dn, e, "f");
    }
    get type() {
      return Ln(this, Dn, "f").type;
    }
    get description() {
      return Ln(this, Dn, "f").description;
    }
    get suffixes() {
      return Ln(this, Dn, "f").suffixes;
    }
    get enabledPlugin() {
      return Ln(this, Dn, "f").enabledPlugin;
    }
    get [((Dn = new WeakMap()), Symbol.toStringTag)]() {
      return "MimeType";
    }
  }
  class Un extends Nn {
    ...
    get [((Mn = new WeakMap()), ($n = new WeakMap()), (On = new WeakMap()), Symbol.toStringTag)]() {
      return "Plugin";
    }
  }
  class Bn {
    constructor(e) {
      In.set(this, void 0), Tn.set(this, void 0), Wn(this, In, [], "f"), Wn(this, Tn, {}, "f");
      for (let n = 0; n < e.length; n++) this.install(e[n]);
    }
    install(e) {
      const n = Ln(this, In, "f").length;
      Ln(this, In, "f").push(e),
        (Ln(this, Tn, "f")[e.name] = e),
        Object.defineProperty(this, e.name, { configurable: !0, enumerable: !1, value: e }),
        (this[n] = e);
    }
    item(e) {
      return Ln(this, In, "f")[e >>> 0];
    }
    namedItem(e) {
      return Ln(this, Tn, "f")[e];
    }
    refresh() {}
    [((In = new WeakMap()), (Tn = new WeakMap()), Symbol.iterator)]() {
      return Ln(this, In, "f")[Symbol.iterator]();
    }
    get [Symbol.toStringTag]() {
      return "PluginArray";
    }
    get length() {
      return Ln(this, In, "f").length;
    }
  }
  const Vn = new Un("Shockwave Flash", "Shockwave Flash 32.0 r0", "ruffle.js");
  Vn.install({ type: qe, description: "Shockwave Flash", suffixes: "spl", enabledPlugin: Vn }),
    Vn.install({ type: Ae, description: "Shockwave Flash", suffixes: "swf", enabledPlugin: Vn }),
    Vn.install({ type: Fe, description: "Shockwave Flash", suffixes: "swf", enabledPlugin: Vn }),
    Vn.install({ type: Pe, description: "Shockwave Flash", suffixes: "swf", enabledPlugin: Vn });
  const Hn = window.RufflePlayer?.config ?? {},
    Jn =
      (function (e) {
        let n = Me?.href ?? "";
        return (
          !$e && "publicPath" in e && null !== e.publicPath && void 0 !== e.publicPath && (n = e.publicPath),
          "" === n || n.endsWith("/") || (n += "/"),
          n
        );
      })(Hn) + "ruffle.js";
  ...
  function Yn() {
    try {
      (Zn = Zn ?? document.getElementsByTagName("object")), (Kn = Kn ?? document.getElementsByTagName("embed"));
      for (const e of Array.from(Zn))
        if (qn.isInterdictable(e)) {
          const n = qn.fromNativeObjectElement(e);
          e.replaceWith(n);
        }
      for (const e of Array.from(Kn))
        if (En.isInterdictable(e)) {
          const n = En.fromNativeEmbedElement(e);
          e.replaceWith(n);
        }
    } catch (e) {
  ...
  function Xn() {
    (Qn = Qn ?? document.getElementsByTagName("iframe")),
      (Gn = Gn ?? document.getElementsByTagName("frame")),
      [Qn, Gn].forEach((e) => {
        for (const n of e) {
          ...
          try {
            "complete" === e.document.readyState && et(e, t);
          } catch (e) {
            $e || console.warn(t + e);
          }
          n.addEventListener(
  ...
  async function et(e, n) {
    ...
    try {
      ...
      return void ($e || console.warn(n + e));
    }
    if ($e || void 0 === t.documentElement.dataset.ruffleOptout)
      if ($e)
        e.RufflePlayer || (e.RufflePlayer = {}), (e.RufflePlayer.config = { ...Hn, ...(e.RufflePlayer.config ?? {}) });
      else if (!e.RufflePlayer) {
        const n = t.createElement("script");
        n.setAttribute("src", Jn),
          (n.onload = () => {
            (e.RufflePlayer = {}), (e.RufflePlayer.config = Hn);
          }),
  ...
  function nt() {
    !(function (e) {
      ...
      ("install" in navigator.plugins && navigator.plugins.install) ||
        (Object.defineProperty(window, "PluginArray", { value: Bn }),
        Object.defineProperty(navigator, "plugins", { value: new Bn(navigator.plugins), writable: !1 })),
        navigator.plugins.install(e),
        !(e.length > 0) ||
          ("install" in navigator.mimeTypes && navigator.mimeTypes.install) ||
          (Object.defineProperty(window, "MimeTypeArray", { value: Nn }),
          Object.defineProperty(window, "MimeType", { value: _n }),
          Object.defineProperty(navigator, "mimeTypes", { value: new Nn(navigator.mimeTypes), writable: !1 }));
      const n = navigator.mimeTypes;
      for (let t = 0; t < e.length; t += 1) n.install(e[t]);
    })(Vn);
  }
  function tt() {
    (("favorFlash" in Hn && !1 === Hn.favorFlash) ||
  ...
  try {
    if (document.currentScript instanceof HTMLScriptElement && "" !== document.currentScript.src) {
      let e = document.currentScript.src;
      e.endsWith(".js") || e.endsWith("/") || (e += "/"), (rt = new URL(".", e));
    }
  } catch (e) {
    console.warn("Unable to get currentScript URL", e);
  }
  !(function (e, n = {}) {
    ...
    window.RufflePlayer instanceof s
      ...
      (t.sources[e] = at),
      (at.options = n),
      !1 !== (!("polyfills" in t.config) || t.config.polyfills) && at.pluginPolyfill();
  })("local", {
    onFirstLoad: () => {
      r.p = (function (e) {
        let n = rt?.href ?? "";
